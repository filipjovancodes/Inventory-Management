...
inventoryTemplateFileDest = r"C:\Users\Filip\OneDrive\Documents\GitHub\MonthlyInventory\InventoryTemplate.xlsx"
oldExcelFileDest = r"C:\Users\Filip\OneDrive\Documents\GitHub\MonthlyInventory\Inventory" + str(getLastMonth()) + ".xlsx"
newExcelFileDest = r"C:\Users\Filip\OneDrive\Documents\GitHub\MonthlyInventory\Inventory" + str(getCurrentMonth()) + ".xlsx"
...
def moveValues(template, oldFile, newFile):
    ...
    while oldInventory.cell(row=i, column=1).value != None:
        newInventory.cell(row= i, column= 12).value = oldInventory.cell(row= i, column= 4).value
        i += 1
    
    #From Stock to Inv Beg
    i = 2
    while oldInventory.cell(row=i, column=1).value != None:
        newInventory.cell(row= i, column= 11).value = oldInventory.cell(row= i, column= 5).value
        i += 1
